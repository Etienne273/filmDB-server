...
var hallroutes_v1 = require('./api/hall.routes.v1');
...
app.use(function (req, res, next) {
    ...
    res.setHeader('Access-Control-Allow-Origin', process.env.ALLOW_ORIGIN || 'https://angular-films.herokuapp.com');
